...
public:
    // cuSnark expects the ZZ field to be before the ZZZ field in memory.
    // This change does not break code depending on the upstream sppark 
    // where fields were private.
    field_t X, Y, ZZ, ZZZ;
